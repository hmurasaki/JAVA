...
public class ArrayListEx02 {
	...
	public static void main(String[] args) {
		...
		ArrayList<Integer> list1 = new ArrayList<>();   //10개의 방 생성
		list1.add(5);     //자동 박싱
		list1.add(4);
		list1.add(2);
		list1.add(0);
		...
		//subList()는 마지막 인덱스를 포합하지 않고 List타입으로 리턴한다.
		ArrayList list2 = new ArrayList(list1.subList(1, 4));
		print(list1, list2);

		//정렬하기
		System.out.println("정렬 후");
		Collections.sort(list1);         //컨+쉬+o     , 기본적으로 오름차순 정렬이 된다.
		...
		//삽입하기
		list2.add("B");			  //배열 복사가 일어나지않음.	
		list2.add("C");			  //배열 복사가 일어나지않음.
		print(list1, list2);
